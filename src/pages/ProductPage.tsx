...
const allProducts = [
  ...
  { slug: 'pet-tincture', name: 'Pet Tincture', strength: '300mg', price: 65, image: '/images/product-pet.jpg', gallery: ['/images/lifestyle-pet.jpg', '/images/article-onset.jpg'], tag: 'For Pets', desc: 'Nano-CBD formulated specifically for your furry family members. Same technology, pet-optimized dosing.', longDesc: "Your pets have the same endocannabinoid system you do — and they experience the same absorption challenges with traditional CBD oil. Our Pet Tincture uses the same nano-technology as our human formulas, delivering 3-8x better absorption in a formulation specifically designed for pet metabolism.\n\nThe unflavored formula mixes easily with food or treats. Every batch is third-party tested to ensure purity and safety for your four-legged family members.", ingredients: 'Nano-encapsulated CBD (cannabidiol isolate), purified water, natural flavoring.', usage: 'Add to food or apply directly to mouth. Dose by weight: Under 25lbs: 0.25ml. 25-50lbs: 0.5ml. Over 50lbs: 1ml. Start low and increase gradually.', specs: { size: '30ml (1 fl oz)', serving: 'Varies by weight (10mg CBD/ml)', servings: '30', thc: '0.0%', lab: 'Third-party tested' } },
];
